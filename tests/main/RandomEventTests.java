...
public class RandomEventTests extends ApplicationTest {
    ...
    @Test
    public void cropYieldIncreaseWithTracktor() throws InterruptedException {
        clickOn("#startGameBtn");
        moveTo("#name").clickOn("#name").write("1");
        moveTo("#difficulty").clickOn("#difficulty").clickOn("Casual");
        moveTo("#FemaleRadioBtn").clickOn("#FemaleRadioBtn");
        ...
        moveTo("#buyItemBtn").clickOn("#buyItemBtn");
        moveTo("#exit").clickOn("#exit");
        moveTo("#fork_tool").clickOn("#fork_tool");
        moveTo("#plot1").clickOn("#plot1");
        moveTo("#cropInventory").clickOn("#cropInventory");
        verifyThat("#onionCropCounter", LabeledMatchers.hasText("6"));

    }

    @Test
    public void maximumWaterLevelIncreaseWithTracktor() throws InterruptedException {
        clickOn("#startGameBtn");
        moveTo("#name").clickOn("#name").write("1");
        moveTo("#difficulty").clickOn("#difficulty").clickOn("Casual");
        moveTo("#FemaleRadioBtn").clickOn("#FemaleRadioBtn");
    ...
    @Test
    public void canBuyAdditionalPlots() throws InterruptedException {
        clickOn("#startGameBtn");
        moveTo("#name").clickOn("#name").write("1");
        moveTo("#difficulty").clickOn("#difficulty").clickOn("Casual");
        moveTo("#FemaleRadioBtn").clickOn("#FemaleRadioBtn");
        ...
        moveTo("#startGameBtn").clickOn("#startGameBtn");
        moveTo("#market").clickOn("#market");
        moveTo("#marketItem9").clickOn("#marketItem9");
        moveTo("#selectedItemQuantity").clickOn("#selectedItemQuantity").write("1");
        moveTo("#buyItemBtn").clickOn("#buyItemBtn");
        moveTo("#exit").clickOn("#exit");
        verifyThat("#money", LabeledMatchers.hasText("$5000"));
